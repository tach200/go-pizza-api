...
func pizzahutDeals(wg *sync.WaitGroup, postcode string, deals []*AllDeals) {
	defer wg.Done()
...
func papajohnsDeals(wg *sync.WaitGroup, postcode string, deals []*AllDeals) {
	defer wg.Done()
...
func dominosDeals(wg *sync.WaitGroup, postcode string, deals []*AllDeals) {
	defer wg.Done()
...
func GetDeals(postcode string) []*AllDeals {
	...
	go pizzahutDeals(&wg, postcode, deals)

	go papajohnsDeals(&wg, postcode, deals)

	go dominosDeals(&wg, postcode, deals)
